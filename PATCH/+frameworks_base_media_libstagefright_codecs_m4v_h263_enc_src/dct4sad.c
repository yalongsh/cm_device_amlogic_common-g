...
static const int ColThInter[32] = {0, 0x1C, 0x4C, 0x6C, 0x9C, 0xBC, 0xEC, 0x10C,
...
static const int ColThIntra[32] = {0, 0x1C, 0x3C, 0x5C, 0x7C, 0x9C, 0xBC, 0xDC,
...
/******************************************************/
/********** IDCT part **************************/
static const  unsigned char imask[8] = {128, 64, 32, 16, 8, 4, 2, 1};
static const  unsigned char mask[8] = {0x7f, 0xbf, 0xdf, 0xef, 0xf7, 0xfb, 0xfd, 0xfe};
...
void (*const idctcolVCA[16])(Short*) =
{
...
void (*const idctrowVCAInter[16])(Short*, UChar*, Int) =
{
...
void (*const idctrowVCAzmv[16])(Short*, UChar*, UChar*, Int) =
{
...
void (*const idctrowVCAIntra[16])(Short*, UChar*, Int) =
{
